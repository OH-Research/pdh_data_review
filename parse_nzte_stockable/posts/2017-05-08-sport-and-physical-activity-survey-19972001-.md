...
description: To monitor physical activity levels in adults and children
...
Does this data set have cost / price data?</td> <td>Info about the health conditions people have (e.g. diagnosis data)? Unsure. Cost/price data? No</td> </tr>
 ...
 <tr> <td width="40%">Brief info about the systems and processes used to collect/manage data. Q: Where the data is collected, in what form, and accessibility?</td> <td>The data comes from Data provided by SPARC </td> </tr>
